...
function saveJournal() {
  ...
  // Sync Google Sheets (si configuré)
  sendToSheets('visite', entry);
...
function buildJournalCard(v, i) {
  ...
  return `
    <div class="entry-card">
      <button class="btn-delete" onclick="delJournal(${i})">🗑</button>
      <div class="entry-top">
 ...
 * @param {number} i - Index dans le tableau filtré affiché
 */
