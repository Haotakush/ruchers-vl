/* ============================================================
   ...
   Contenu obligatoire uniquement :
     1. Identification apiculteur / exploitation
     2. Inventaire des ruchers (+ coordonnées GPS)
     3. Comptes-rendus des visites sanitaires
     4. Traitements anti-varroas (registre sanitaire)
   ============================================================ */
...
function buildSection3_Visites() {
  if (!journalData.length) {
    return `<div class="registre-section">
      <div class="registre-section-title">3. Comptes-rendus des visites sanitaires (0 entrées)</div>
  ...
  return `<div class="registre-section">
    <div class="registre-section-title">3. Comptes-rendus des visites sanitaires (${journalData.length} entrées)</div>
    <table class="registre-table">
      <thead><tr>
...
/* ---- 4. Traitements anti-varroas ---- */
function buildSection4_Traitements() {
  if (!sanitaireData.length) {
    return `<div class="registre-section">
      <div class="registre-section-title">4. Traitements anti-varroas et registre sanitaire (0 entrées)</div>
  ...
  return `<div class="registre-section">
    <div class="registre-section-title">4. Traitements anti-varroas et registre sanitaire (${sanitaireData.length} entrées)</div>
    <table class="registre-table">
      <thead><tr>
        <th>Date</th><th>Rucher</th><th>Type</th><th>Produit</th>
        <th>Dose</th><th>Durée</th><th>GDSA</th><th>Motif / Ordonnance</th>
      </tr></thead>
      <tbody>${rows}</tbody>
    </table>
